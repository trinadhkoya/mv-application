...
public class JSONArrayRequestTask extends BaseTask<String, Void, JSONArray> {
    ...
    JSONArrayRequestTask(MindValleyHTTP.Method method, String url, ArrayList<RequestParameter> requestParameters, ArrayList<HeaderParameter> headerParameters, HttpListener<JSONArray> listener) {
        this.mMethod = method;
        this.mUrl = url;
